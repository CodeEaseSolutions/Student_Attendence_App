...
class CourseWiseStudent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String? course = ModalRoute.of(context)!.settings.arguments as String;
    ...
    return SafeArea(child: Scaffold(
      appBar:  AppBar(
        ...
        title: Text('$course Students'.toUpperCase(),style: TextStyle(color: Colors.white,fontSize: 15,),),
      ),
      body:
      StreamBuilder(
            ...
            return Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context,index){
                    ...
                    if(student['course'].toLowerCase() ==course){
                      return Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      CustomButton(
                                        ...
                                        btnText: "Present",btnVerticalPadding: 14,btnHorizontalPadding: 16.0,bgColor: Colors.green,),
                                      CustomButton( callback: (){
                                        markAttendence(student,"Absent");
                                      },btnText: "Absent",btnVerticalPadding: 14,btnHorizontalPadding: 16.0,bgColor: Colors.red,)
                                    ],
                                  ),
                                ),
                                Visibility(
